...
public:
    ...
    virtual Token* CreateUndefinedToken(std::string input, int lineNumber) {return new Token(TokenType::UNDEFINED, input, lineNumber);}

    int NewLinesRead() const { return newLines; }
    int SpacesRead() const { return spaces; }
